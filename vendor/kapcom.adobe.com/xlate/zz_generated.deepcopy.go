...
func (in *HashPolicy) DeepCopyInto(out *HashPolicy) {
	*out = *in
	...
	if in.QueryParameter != nil {
		...
		*out = new(HashPolicyQueryParameter)
		**out = **in
	}
	if in.Cookie != nil {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *HashPolicyQueryParameter) DeepCopyInto(out *HashPolicyQueryParameter) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new HashPolicyQueryParameter.
func (in *HashPolicyQueryParameter) DeepCopy() *HashPolicyQueryParameter {
	if in == nil {
		return nil
	}
	out := new(HashPolicyQueryParameter)
