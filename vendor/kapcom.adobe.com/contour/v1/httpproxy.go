...
type Route struct {
	...
	// HashPolicy
	HashPolicy []common.HashPolicy `json:"adobe:hashPolicy,omitempty"`
...
type TCPProxy struct {
	...
	// +optional
	LeastRequestLbConfig *LeastRequestLbConfig `json:"adobe:leastRequestLbConfig, omitempty"`
	// SourceIp request load balancing config
	// +optional
	SourceIpLbConfig *SourceIpLbConfig `json:"adobe:sourceIpLbConfig,omitempty"`
	// Services are the services to proxy traffic
	Services []Service `json:"services,omitempty"`
...
// ConnectionLbConfig -- loadbalancer policy exposing envoy's source ip lb policy
type SourceIpLbConfig struct {
